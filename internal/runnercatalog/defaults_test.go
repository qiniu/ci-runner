...
func TestDefaultProfilesMatchTargetCatalog(t *testing.T) {
	want := []state.RunnerProfile{
		...
		{
			Name:                "qiniu-ubuntu-slim-large",
			Labels:              []string{"self-hosted", "linux", "x64", "qiniu", "ubuntu-slim-large"},
			RequiredLabels:      []string{"qiniu", "ubuntu-slim-large"},
			DefaultTemplateName: "github-runner-ubuntu-slim-large",
			MaxConcurrency:      10,
			Priority:            100,
			Enabled:             true,
			ManagedBy:           "qiniu/ci-runner",
		...
		{
			Name:                "qiniu-ubuntu-22.04-large",
			Labels:              []string{"self-hosted", "linux", "x64", "qiniu", "ubuntu-22.04-large"},
			RequiredLabels:      []string{"qiniu", "ubuntu-22.04-large"},
			DefaultTemplateName: "github-runner-ubuntu-22.04-large",
			MaxConcurrency:      10,
			Priority:            100,
			Enabled:             true,
			ManagedBy:           "qiniu/ci-runner",
		...
		{
			Name:                "qiniu-ubuntu-24.04-large",
			Labels:              []string{"self-hosted", "linux", "x64", "qiniu", "ubuntu-24.04-large"},
			RequiredLabels:      []string{"qiniu", "ubuntu-24.04-large"},
			DefaultTemplateName: "github-runner-ubuntu-24.04-large",
			MaxConcurrency:      10,
			Priority:            100,
			Enabled:             true,
			ManagedBy:           "qiniu/ci-runner",
		...
		{
			Name:                "qiniu-ubuntu-26.04-large",
			Labels:              []string{"self-hosted", "linux", "x64", "qiniu", "ubuntu-26.04-large"},
			RequiredLabels:      []string{"qiniu", "ubuntu-26.04-large"},
			DefaultTemplateName: "github-runner-ubuntu-26.04-large",
			MaxConcurrency:      10,
			Priority:            100,
			Enabled:             true,
			ManagedBy:           "qiniu/ci-runner",
...
func TestDefaultProfilesReferenceTrackedPublicTemplates(t *testing.T) {
	templateDirectories := map[string]string{
		...
		"ubuntu-slim-large":  "github-runner-ubuntu-slim-large",
		"ubuntu-22.04-large": "github-runner-ubuntu-22.04-large",
		"ubuntu-24.04-large": "github-runner-ubuntu-24.04-large",
		"ubuntu-26.04-large": "github-runner-ubuntu-26.04-large",
	}
