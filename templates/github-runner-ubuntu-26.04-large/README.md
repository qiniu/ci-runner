# GitHub runner Ubuntu 26.04 large template

This large variant reuses the pinned Ubuntu 26.04 Dockerfile, toolset, scripts,
...
provider allocation, not qshell configuration. This is a preview template.

Build with `task template-build-ubuntu-26-04-large` after setting the provider
