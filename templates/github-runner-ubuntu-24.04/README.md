...
This stable 8-vCPU, 8192-MiB Linux x86_64 template requests 20 GiB of build
free space when created. It uses the pinned Canonical-published Ubuntu 24.04 OCI index in
