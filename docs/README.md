...
- [Current Work Handoff (Chinese)](current-work-handoff.md): llgo Job timeout evidence, runnerd lifecycle analysis, proposed diagnostics improvements, and cross-computer resume instructions; proposals are not implemented.
